...
enum ItalianStrings {
    static let table: [L10nKey: String] = [
        ...
        .paywall_then_weekly:            "$14.99/settimana. Si rinnova automaticamente salvo disdetta.",
        .paywall_then_monthly:           "7 giorni gratis, poi $39.99/mese. Si rinnova automaticamente salvo disdetta.",
