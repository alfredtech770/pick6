...
enum SpanishStrings {
    static let table: [L10nKey: String] = [
        ...
        .paywall_then_weekly:            "$14.99/semana. Se renueva automáticamente salvo cancelación.",
        .paywall_then_monthly:           "7 días gratis, luego $39.99/mes. Se renueva automáticamente salvo cancelación.",
