...
enum ArabicStrings {
    static let table: [L10nKey: String] = [
        ...
        .paywall_fineprint_weekly:       "14.99$ أسبوعيًا. يتجدّد الاشتراك تلقائيًا ما لم يُلغَ قبل انتهاء الفترة بـ 24 ساعة على الأقل. تُعالَج المدفوعات عبر معرّف Apple الخاص بك.",
        ...
        .paywall_then_weekly:            "14.99$ أسبوعيًا. يتجدد تلقائيًا ما لم يتم الإلغاء.",
        .paywall_then_monthly:           "7 أيام مجانًا، ثم 39.99$ شهريًا. يتجدد تلقائيًا ما لم يتم الإلغاء.",
