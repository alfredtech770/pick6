...
enum PortugueseStrings {
    static let table: [L10nKey: String] = [
        ...
        .paywall_then_weekly:            "$14.99/semana. Renova automaticamente salvo cancelamento.",
        .paywall_then_monthly:           "7 dias grátis, depois $39.99/mês. Renova automaticamente salvo cancelamento.",
