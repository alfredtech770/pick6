...
enum GermanStrings {
    static let table: [L10nKey: String] = [
        ...
        .paywall_then_weekly:            "$14.99/Woche. Verlängert sich automatisch, sofern nicht gekündigt.",
        .paywall_then_monthly:           "7 Tage gratis, dann $39.99/Monat. Verlängert sich automatisch, sofern nicht gekündigt.",
